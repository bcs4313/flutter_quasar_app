...
class NodePainterAssembler extends CustomPainter {
  ...
  NodePainterAssembler(ControllerTreeAssembler controller)
  {
  ...
  void paint(Canvas canvas, Size size)
  {
    ...
    List<NodePairAssembler> pairs = controller.model.pairs;
    for(int i = 0; i < pairs.length; i++)
      {
        NodePairAssembler np = pairs[i];
        ViewTreeNodeStatic front = np.front;
        ViewTreeNodeStatic back = np.back;
