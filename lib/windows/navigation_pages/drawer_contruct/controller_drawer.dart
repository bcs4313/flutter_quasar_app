...
import 'package:flutter_quasar_app/windows/navigation_pages/event_editor/create_event/view_event_editor.dart';
  ...
  static void transferFlex(String locale)
  {
    switch(locale)
    {
      ...
      case("ViewEventEditor"):
        Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => ViewEventEditor()));
        break;
    }
  }
}