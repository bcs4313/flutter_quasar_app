    ...
    return Drawer(
      child: ListView(
        ...
        children: <Widget>[
          ...
          DrawerUtility.createDrawerItem(context: context, icon: Icons.supervised_user_circle, text: 'My Friends', locale: "ViewHomepage"),
          DrawerUtility.createDrawerItem(context: context, icon: Icons.double_arrow_sharp, text: 'Join an Event', locale: "ViewHomepage"),
          Divider(),
          DrawerUtility.createDrawerItem(context: context, icon: Icons.mode_edit, text: 'Event Editor', locale: "ViewEventEditor"),
          DrawerUtility.createDrawerItem(context: context, icon: Icons.face, text: 'Edit my Profile', locale: "ViewHomepage"),
